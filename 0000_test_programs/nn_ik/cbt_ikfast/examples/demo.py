...
import ur3e_ikfast
import ur5_ikfast
import cvrb038_ikfast

# Initialize kinematics for UR5 robot arm
cbt038_kin = cvrb038_ikfast.PyKinematics()
n_joints = cbt038_kin.getDOF()
...
print("Joint angles:")
print(joint_angles)
ee_pose = cbt038_kin.forward(joint_angles)
...
joint_configs = cbt038_kin.inverse(ee_pose.reshape(-1).tolist())
