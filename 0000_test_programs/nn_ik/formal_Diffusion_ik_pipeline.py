...
if __name__ == '__main__':
    ...
    if mode == 'train':
        ...
        '''load the model'''
        model_path = '0000_test_programs/nn_ik/results/saved_model/cobotta_diffusion_ik.pt'  # pred noise = false
        '''ur3'''
        ...
        '''yumi'''
        # model_path = '0000_test_programs/nn_ik/results/0217_2056_unet1d_h4_steps20_train/diffusion_ckpt_latest.pt'   # pred noise = true
        '''cobotta pro 1300'''
