...
agent_pos_ds = root.create_dataset("agent_pos", shape=(0, 7), chunks=(1, 7), dtype=np.float32, append=True)
image_ds = root.create_dataset("images", shape=(0, 96, 192, 3), chunks=(1, 96, 192, 3), dtype=np.uint8, append=True)
