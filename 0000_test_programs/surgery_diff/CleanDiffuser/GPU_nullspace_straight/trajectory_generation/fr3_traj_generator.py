...
SCRIPT_PATH = Path(__file__).resolve().parent / 'franka_research_3_gpu_nullspace_straight_demo.py'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--output', type=str, default=str(Path(__file__).resolve().parent / 'franka_research_3_gpu_trajectories.hdf5'))
